...
<p align="center"><a href= "home.php"> HOME </a>|<a href= "index.php"> MODULES</a></p>
...
echo'<br/><br/>';
$sql="SELECT * FROM faq";
$res=mysqli_query($db_connection,"SELECT * FROM faq where faq.subcat_id= '".$ids."'") or die(mysqli_error());
